...
[![Version](https://img.shields.io/badge/Version-4.169-46B1EF?style=for-the-badge)](CHANGELOG.md)
...
>
> The earlier hand-built HTML mockups are **preserved, not deleted**, in [`_archive/`](_archive/) — unlinked from the landing page but reachable by direct URL. The persona / scenario / design-system sections further down describe those **archived mockups**, which remain the design spec for surfaces JFT has not built yet.
...
- An **About SkillProof** sidebar with two links: the one-slide pitch page, and the **Full Walkthrough (2K)** video (opens in a new tab)
...
**Latest: v4.169 (13 Aug 2026)** — added the 2K full walkthrough (2560×2000, 4m19s) as a second landing-page link under One-Slide Pitch. **v4.168 (13 Aug 2026)** — demo rebuilt on STU101 with the AI interaction loop on all three sides (student assessment, student coaching, instructor Skill Preview); frames made full-browser-width with internal scroll; captures moved to 1920px; Instructor granted B002 so every role shows the same course; capture harness gated on content readiness after three screens shipped as loading skeletons. **v4.167 (23 Jul 2026)** — the four persona portals were replaced by live-app screenshot walkthroughs and the hand-built mockups archived.
