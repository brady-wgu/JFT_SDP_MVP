...
[![Version](https://img.shields.io/badge/Version-4.170-46B1EF?style=for-the-badge)](CHANGELOG.md)
...
- An **About SkillProof** sidebar with three links: the one-slide pitch page, the **Full Walkthrough (2K)** video (opens in a new tab), and the **Status Demo Deck** (`.pptx`, downloads)
